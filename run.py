...
dockerCommand = 'docker-compose -f elastest-data-manager/deploy/docker-compose.yml -f elastest-torm/deploy/docker-compose.yml -f elastest-service-manager/deploy/docker-compose.yml -p elastest up -d'
